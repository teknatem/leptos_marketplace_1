...
pub enum S3FileCategory {
    ...
    LlmChatImages,
    #[serde(rename = "ticket_attachments")]
    TicketAttachments,
    #[serde(rename = "other")]
    Other,
}
...
impl S3FileCategory {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            Self::TicketAttachments => "ticket_attachments",
            Self::Other => "other",
        }
    }
    ...
    pub fn label_ru(&self) -> &'static str {
        match self {
            ...
            Self::TicketAttachments => "Вложения тикетов",
            Self::Other => "Другое",
        }
    }
...
impl From<&str> for S3FileCategory {
    fn from(value: &str) -> Self {
        match value {
            ...
            "ticket_attachments" => Self::TicketAttachments,
            "other" => Self::Other,
            _ => Self::Other,
        }
    }
