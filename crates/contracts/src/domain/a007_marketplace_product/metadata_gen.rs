...
pub const ENTITY_METADATA: EntityMetadataInfo = EntityMetadataInfo {
    ...
    ai: EntityAiMetadata {
        description: "Товар на маркетплейсе — карточка товара с SKU, артикулом и категорией. Связывает номенклатуру 1С с карточкой на маркетплейсе (WB, Ozon, ЯМ). Используется как опорный справочник при импорте продаж, заказов и отчётов.",
        questions: &["Как найти товар по артикулу?", "Как привязать товар маркетплейса к номенклатуре 1С?", "Какие товары есть на Wildberries?"],
...
pub const FIELDS: &[FieldMetadata] = &[
    ...
    FieldMetadata {
        ...
        ai_hint: Some("Внутренний идентификатор товара на маркетплейсе (nmId для WB, product_id для Ozon)."),
        nested_fields: None,
        ref_aggregate: None,
        enum_values: None,
    },
    FieldMetadata {
        ...
        ai_hint: Some("Артикул продавца — используется для сопоставления с номенклатурой 1С."),
        nested_fields: None,
        ref_aggregate: None,
        enum_values: None,
    },
