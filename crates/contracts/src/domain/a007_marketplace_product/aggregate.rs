...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct WbMappingProblemDto {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct WbMappingProblemsResponse {
    pub items: Vec<WbMappingProblemDto>,
    pub total: usize,
...
/// «Устаревшие» = строки регистров (a012/a015/p903), у которых nomenclature_ref пуст
/// или не совпадает с актуальным a007.nomenclature_ref в текущем кабинете.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct WbStalePostingsSummary {
    pub doc_count: i64,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct WbStalePostingsRequest {
    pub connection_mp_ref: String,
    pub nm_id: i64,
    pub supplier_article: Option<String>,
    pub date_from: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct WbStalePostingsRepostResponse {
    pub total: usize,
    pub succeeded: usize,
    pub failed: usize,
