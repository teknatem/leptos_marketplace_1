...
pub struct AddContextRequest {
    ...
    /// Приложить снимок последних открытых пользователем страниц: путь до обращения.
    /// Нужен чату поддержки; аналитическому чату по объекту — нет.
    #[serde(default)]
    pub with_session_snapshot: bool,
}
