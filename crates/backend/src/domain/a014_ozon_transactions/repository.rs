...
impl From<Model> for OzonTransactions {
    fn from(m: Model) -> Self {
        ...
        OzonTransactions {
            ...
            source_meta,
            is_posted: m.is_posted,
            posting_ref: m.posting_ref,
            posting_ref_type: m.posting_ref_type,
        }
    }
}
...
pub async fn upsert_by_operation_id(aggregate: &OzonTransactions) -> Result<Uuid> {
    ...
    if let Some(existing_txn) = existing {
        ...
        let active = ActiveModel {
            ...
            posting_ref: Set(aggregate.posting_ref.clone()),
            posting_ref_type: Set(aggregate.posting_ref_type.clone()),
