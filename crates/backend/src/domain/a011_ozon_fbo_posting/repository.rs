...
#[sea_orm(table_name = "a011_ozon_fbo_posting")]
pub struct Model {
    ...
    pub created_at_source: Option<chrono::DateTime<chrono::Utc>>,
...
impl From<Model> for OzonFboPosting {
...
pub async fn upsert_document(aggregate: &OzonFboPosting) -> Result<Uuid> {
    ...
    if let Some(existing_doc) = existing {
        ...
        let active = ActiveModel {
            ...
            created_at_source: Set(aggregate.state.created_at),
